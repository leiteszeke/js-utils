	...
	describe('test isEqual', () => {
		describe('check if obj1 is equal to obj2', () => {
			it('should return that obj1 is equal to obj2', () => {
				const obj1 = { name: 'user', data: { email: 'obj@email.com', phone: 123455, favourites: [1, 2] } };
				const obj2 = { data: { email: 'obj@email.com', phone: 123455, favourites: [1, 2] }, name: 'user' };
			...
			it('should return that obj1 is not equal to obj2', () => {
				const obj1 = { name: 'user', data: { email: 'obj@email.com', phone: 123455, favourites: [1, 2] } };
				const obj2 = { name: 'pedro', data: { email: 'obj@email.com', phone: 123455, favourites: [1, 2] } };
